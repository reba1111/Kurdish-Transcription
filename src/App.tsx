                      ...
                      {audioUrl && (
                        <div className="bg-[#0a0a0b] rounded-xl border border-[#ffffff08] overflow-hidden p-3 space-y-3" dir="ltr">
                          ...
                          >
                            ...
                            {abPoint !== null && bbPoint !== null && audioDuration > 0 && (
                              <div
                                ...
                                style={{
                                  left: `${(abPoint / audioDuration) * 100}%`,
                                  width: `${((bbPoint - abPoint) / audioDuration) * 100}%`,
                                }}
                              />
                            )}
                            ...
                            {audioDuration > 0 && (
                              <div
                                className="absolute top-1/2 -translate-y-1/2 h-1.5 bg-white/30 rounded-full pointer-events-none"
                                style={{ width: `${(playerTime / audioDuration) * 100}%` }}
                              />
                            )}
                          ...
                          <div className="flex items-center gap-2 flex-wrap">
                            ...
                            <button
                              onClick={togglePlay}
                              className="w-9 h-9 flex items-center justify-center rounded-full bg-white text-[#0a0a0b] hover:bg-[#e0e0e0] transition-colors shrink-0 shadow"
                            >
                              {isPlaying
                            ...
                            {abPoint !== null && bbPoint !== null && (
                              <button
                                onClick={() => {
                                  ...
                                  if (next) {
                                    const el = audioElRef.current;
                                    if (el) { el.currentTime = abPoint!; el.play(); }
                                  }
                                }}
                            ...
                            {(abPoint !== null || bbPoint !== null) && (
                              <button
                                onClick={clearAB}
                                className="ml-auto text-[#444] hover:text-[#888] transition-colors text-[10px] uppercase tracking-wider"
                              >
                                پاک
                              </button>
                            )}
                            ...
                            >
                              <div className="p-4 space-y-4">
                                ...
                                {(abPoint !== null || bbPoint !== null) && (
                                  <button
                                    onClick={() => {
                                      if (abPoint !== null) setRangeStart(fmtMMSS(abPoint));
                                      if (bbPoint !== null) setRangeEnd(fmtMMSS(bbPoint));
                                    }}
