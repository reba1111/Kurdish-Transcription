...
import { Mic, Square, Upload, Copy, Check, FileAudio, Loader2, Trash2, History, Clock, ChevronDown, LogOut, User } from "lucide-react";
          ...
          >
            <div className="flex items-center justify-between px-5 sm:px-7 py-4 border-b border-[#ffffff08]">
              <div className="flex items-center gap-2">
                ...
                {history.length > 0 && <span className="text-[10px] px-2 py-0.5 bg-[#ffffff08] rounded-full text-[#666]">{history.length}</span>}
              </div>
              {history.length > 0 && (
